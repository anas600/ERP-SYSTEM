...
public class ItemsController : ControllerBase
{
    ...
    public ItemsController(IItemService s, IValidator<CreateItemRequest> c, IValidator<UpdateItemRequest> u)
    { _service = s; _createV = c; _updateV = u; }
    ...
    {
        var r = await _service.ListAsync(companyId, categoryId, includeInactive, skip, take, ct);
